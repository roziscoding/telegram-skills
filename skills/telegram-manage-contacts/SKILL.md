...
The binary is at `<skill-dir>/../../bin/telegram`.

### Add or update a contact

```bash
<skill-dir>/../../bin/telegram --contact-add alice 123456789
```
...
```bash
<skill-dir>/../../bin/telegram --list-contacts
```
...
```bash
<skill-dir>/../../bin/telegram --delete-contact alice
```
